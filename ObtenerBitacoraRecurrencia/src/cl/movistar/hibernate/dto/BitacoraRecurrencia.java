...
public class BitacoraRecurrencia  implements java.io.Serializable {
     ...
     private String idBolsa;// codigo oferta
    ...
    public BitacoraRecurrencia(Date fechaInicio, int idTracking, String idBolsa, String nombreBolsa) {
        this.fechaInicio = fechaInicio;
        this.idTracking = idTracking;
        this.idBolsa = idBolsa;
        this.nombreBolsa = nombreBolsa;
    }
    public BitacoraRecurrencia(Date fechaInicio, Date fechaFin, int idTracking, String idBolsa, String nombreBolsa) {
       this.fechaInicio = fechaInicio;
